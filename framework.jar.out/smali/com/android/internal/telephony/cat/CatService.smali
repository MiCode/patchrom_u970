...
.method private handleCmdResponse(Lcom/android/internal/telephony/cat/CatResponseMessage;)V
    ...
    .line 1222
    .local v7, cmdType:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    if-nez v7, :cond_2
    ...
    const-string v1, "Error:handleCmdResponse(),Unsupported Command Type:"
    ...
    .line 1298
    .end local v7           #cmdType:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    :cond_1
    :goto_1
    :pswitch_2
    ...
    .line 1225
    .restart local v7       #cmdType:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    :cond_2
    ...
    invoke-direct {p0, v0, v8}, Lcom/android/internal/telephony/cat/CatService;->sendMenuSelection(IZ)V
    ...
    const-string v1, "liutao,handleCmdResponse(),SELECT_ITEM = "
    ...
    iget-boolean v1, v9, Lcom/android/internal/telephony/cat/Input;->ucs2:Z
...
.method private handleProactiveCommand(Lcom/android/internal/telephony/cat/CommandParams;)V
    ...
    invoke-interface {v0, v5}, Lcom/android/internal/telephony/CommandsInterface;->resetRadio(Landroid/os/Message;)V
    ...
    .line 754
    :pswitch_9
    const-string v0, "handleProactiveCommand SEND_SMS"
    ...
    .line 757
    const-string v0, "handleProactiveCommand responseNeeded"
    ...
    .line 762
    :pswitch_a
    const-string v0, "handleProactiveCommand SEND_SS"
    ...
    .line 766
    check-cast v0, Lcom/android/internal/telephony/cat/CallForwardParams;

    iget-object v7, v0, Lcom/android/internal/telephony/cat/CallForwardParams;->callForwardNum:Ljava/lang/String;

    .line 767
    .local v7, callForwardNum:Ljava/lang/String;
    check-cast p1, Lcom/android/internal/telephony/cat/CallForwardParams;

    .end local p1
    iget-boolean v6, p1, Lcom/android/internal/telephony/cat/CallForwardParams;->bEnable:Z
    ...
    const-string v1, "CatCmdMessage SEND_SS callForwardNum: "
    ...
    .line 770
    invoke-virtual {v8}, Lcom/android/internal/telephony/cat/CatCmdMessage;->getCallForward()Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;

    move-result-object v0

    iget-boolean v6, v0, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->bEnable:Z
    ...
    iget-object v7, v0, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->callForwardNum:Ljava/lang/String;

    .line 772
    new-instance v10, Lcom/android/internal/telephony/cat/CatService$UsatSendSS;

    invoke-direct {v10, p0, v7, v6}, Lcom/android/internal/telephony/cat/CatService$UsatSendSS;-><init>(Lcom/android/internal/telephony/cat/CatService;Ljava/lang/String;Z)V

    .line 795
    .local v10, mSendSS:Lcom/android/internal/telephony/cat/CatService$UsatSendSS;
    goto/16 :goto_2
...
.method private handleRilMsg(Lcom/android/internal/telephony/cat/RilMessage;)V
    ...
    .line 623
    const-string v1, "handleRilMsg MSG_ID_PROACTIVE_COMMAND call handleProactiveCommand"
    ...
    .line 658
    const-string v1, "handleRilMsg MSG_ID_REFRESH call handleProactiveCommand"

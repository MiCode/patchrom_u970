...
.method constructor <init>(Lcom/android/internal/telephony/cat/CommandParams;)V
    ...
    .line 39
    iput-object v1, p0, Lcom/android/internal/telephony/cat/CatCmdMessage;->mCallForward:Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;
    ...
    .restart local p1
    :pswitch_2
    const-string v1, "CatCmdMessage SEND_SS"
    ...
    const-string v2, "CatCmdMessage ((CallForwardParams)cmdParams).bEnable: "
    ...
    check-cast v1, Lcom/android/internal/telephony/cat/CallForwardParams;

    iget-boolean v1, v1, Lcom/android/internal/telephony/cat/CallForwardParams;->bEnable:Z
    ...
    const-string v2, "CatCmdMessage ((CallForwardParams)cmdParams).callForwardNum: "
    ...
    iget-object v1, v1, Lcom/android/internal/telephony/cat/CallForwardParams;->callForwardNum:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/android/internal/telephony/cat/CallForwardParams;->textMsg:Lcom/android/internal/telephony/cat/TextMessage;

    iput-object v1, p0, Lcom/android/internal/telephony/cat/CatCmdMessage;->mTextMsg:Lcom/android/internal/telephony/cat/TextMessage;

    .line 132
    new-instance v1, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;

    invoke-direct {v1, p0}, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;-><init>(Lcom/android/internal/telephony/cat/CatCmdMessage;)V
    ...
    iput-object v1, v2, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->callMsg:Lcom/android/internal/telephony/cat/TextMessage;
    ...
    iput-boolean v1, v2, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->bEnable:Z
    ...
    .end local p1
    iget-object v2, p1, Lcom/android/internal/telephony/cat/CallForwardParams;->callForwardNum:Ljava/lang/String;

    iput-object v2, v1, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->callForwardNum:Ljava/lang/String;
    ...
    const-string v2, "CatCmdMessage mCallForward.bEnable: "
    ...
    iget-boolean v2, v2, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->bEnable:Z
    ...
    const-string v2, "CatCmdMessage mCallForward.callForwardNum: "
    ...
    iget-object v2, v2, Lcom/android/internal/telephony/cat/CatCmdMessage$CallForward;->callForwardNum:Ljava/lang/String;
    ...
    .end local p1
    iget-object v2, p1, Lcom/android/internal/telephony/cat/CallSetupParams;->callNum:Ljava/lang/String;

    iput-object v2, v1, Lcom/android/internal/telephony/cat/CatCmdMessage$CallSettings;->callNum:Ljava/lang/String;

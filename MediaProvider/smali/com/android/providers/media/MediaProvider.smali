...
.field private static mflashpath:Ljava/lang/String;

.field private static msdcardpath:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 194
    iput-boolean v3, p0, Lcom/android/providers/media/MediaProvider;->mIsShutDowning:Z
    ...
    iput-object v0, p0, Lcom/android/providers/media/MediaProvider;->mShutdownIntentReceiver:Landroid/content/BroadcastReceiver;
...
.method static synthetic access$100(Lcom/android/providers/media/MediaProvider;)Z
    ...
    .prologue
    .line 97
    iget-boolean v0, p0, Lcom/android/providers/media/MediaProvider;->mIsShutDowning:Z
...
.method static synthetic access$102(Lcom/android/providers/media/MediaProvider;Z)Z
    ...
    .prologue
    .line 97
    iput-boolean p1, p0, Lcom/android/providers/media/MediaProvider;->mIsShutDowning:Z
...
.method static synthetic access$400()Ljava/lang/String;
    ...
    .prologue
    .line 97
    sget-object v0, Lcom/android/providers/media/MediaProvider;->mflashpath:Ljava/lang/String;
...
.method private attachVolume(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v0}, Landroid/os/Environment;->getStorageStateByType(I)Ljava/lang/String;
    ...
    .line 4515
    sget-object v0, Lcom/android/providers/media/MediaProvider;->msdcardpath:Ljava/lang/String;
    ...
    .line 4517
    iget v0, p0, Lcom/android/providers/media/MediaProvider;->moldvolumeid:I
    ...
    sget-object v4, Lcom/android/providers/media/MediaProvider;->msdcardpath:Ljava/lang/String;

    invoke-direct {p0, v4}, Lcom/android/providers/media/MediaProvider;->getStorageId(Ljava/lang/String;)I
    ...
    const-string v4, "delete success number = "
    ...
    .line 4524
    iput v1, p0, Lcom/android/providers/media/MediaProvider;->moldvolumeid:I
    ...
    sget-object v1, Lcom/android/providers/media/MediaProvider;->mflashpath:Ljava/lang/String;
    ...
    sget-object v3, Lcom/android/providers/media/MediaProvider;->msdcardpath:Ljava/lang/String;

    invoke-direct {p0, v3}, Lcom/android/providers/media/MediaProvider;->getStorageId(Ljava/lang/String;)I
    ...
    const-string v3, "delete success number = "
...
.method private createDefaultFolders(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 585
    sget-object v3, Lcom/android/providers/media/MediaProvider;->sDefaultFolderNames:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/providers/media/MediaProvider;->insertDirectory(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)J
    ...
    .line 596
    invoke-static {v4, v8}, Landroid/os/Environment;->getStoragePublicDirectoryByType(Ljava/lang/String;I)Ljava/io/File;

    move-result-object v4

    .line 597
    invoke-static {v8}, Landroid/os/Environment;->getStorageStateByType(I)Ljava/lang/String;
...
.method private generateFileName(ZLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/providers/media/MediaProvider;->mflashpath:Ljava/lang/String;
...
.method private static getCompressedAlbumArt(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    invoke-direct {v5, p0}, Landroid/media/MediaScanner;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v5, v7}, Landroid/media/MediaScanner;->extractAlbumArt(Ljava/io/FileDescriptor;)[B
    :try_end_0
    ...
    invoke-static {v5, v8}, Landroid/os/Environment;->getStoragePublicDirectoryByType(Ljava/lang/String;I)Ljava/io/File;
    ...
    .line 4073
    sget-object v10, Lcom/android/providers/media/MediaProvider;->sFolderArtMap:Ljava/util/HashMap;
    ...
    .line 4074
    :try_start_2
    sget-object v8, Lcom/android/providers/media/MediaProvider;->sFolderArtMap:Ljava/util/HashMap;
...
.method private insertFile(Lcom/android/providers/media/MediaProvider$DatabaseHelper;Landroid/net/Uri;Landroid/content/ContentValues;IZ)J
    ...
    sget-object v9, Lcom/android/providers/media/MediaProvider;->mflashpath:Ljava/lang/String;
...
.method private static updateDatabase(Landroid/database/sqlite/SQLiteDatabase;ZII)V
    ...
    .line 1719
    const-string v0, "ALTER TABLE files ADD COLUMN extension TEXT ;"
    ...
    .line 1727
    const-string v0, "CREATE VIEW images AS SELECT _id,_data,_size,_display_name,mime_type,title,date_added,date_modified,description,picasa_id,isprivate,latitude,longitude,datetaken,orientation,mini_thumb_magic,bucket_id,bucket_display_name,width,height,extension FROM files WHERE media_type=1;"

    invoke-virtual {p0, v0}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 1730
    const-string v0, "CREATE VIEW video AS SELECT _id,_data,_display_name,_size,mime_type,date_added,date_modified,title,duration,artist,album,resolution,description,isprivate,tags,category,language,mini_thumb_data,latitude,longitude,datetaken,mini_thumb_magic,bucket_id,bucket_display_name,bookmark,width,height,extension FROM files WHERE media_type=3;"
...
.method public onCreate()Z
    ...
    const-string v2, "zte.emode.delete"
    ...
    .line 648
    iget-object v2, p0, Lcom/android/providers/media/MediaProvider;->mShutdownIntentReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-static {v0}, Landroid/os/Environment;->getStorageDirectoryByType(I)Ljava/io/File;
    ...
    sput-object v0, Lcom/android/providers/media/MediaProvider;->msdcardpath:Ljava/lang/String;
    ...
    const-string v2, "msdcardpath is "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget-object v2, Lcom/android/providers/media/MediaProvider;->msdcardpath:Ljava/lang/String;
    ...
    .line 660
    invoke-static {v5}, Landroid/os/Environment;->getStorageDirectoryByType(I)Ljava/io/File;
    ...
    sput-object v0, Lcom/android/providers/media/MediaProvider;->mflashpath:Ljava/lang/String;
    ...
    iput v0, p0, Lcom/android/providers/media/MediaProvider;->moldvolumeid:I

    .line 671
    invoke-static {v5}, Landroid/os/Environment;->getStorageStateByType(I)Ljava/lang/String;

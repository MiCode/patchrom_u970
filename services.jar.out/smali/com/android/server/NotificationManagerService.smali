...
.field private lightHandler:Landroid/os/Handler;
...
.field private final updateLights:Ljava/lang/Runnable;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    iput-object v5, p0, Lcom/android/server/NotificationManagerService;->updateLights:Ljava/lang/Runnable;
    ...
    iput-object v5, p0, Lcom/android/server/NotificationManagerService;->lightHandler:Landroid/os/Handler;
...
.method private zteupdateLightsLocked(Landroid/app/Notification;)V
    .locals 7
    .parameter "notification"
    ...
    const-string v4, "updateLightsLocked"
    ...
    const-string v5, "mLedNotification.notification.ledARGB"
    ...
    const-string v5, "mLedNotification.notification.ledOnMS"
    ...
    const-string v5, "mLedNotification.notification.ledOffMS"
    ...
    .line 1099
    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mNotificationLight:Lcom/android/server/LightsService$Light;

    const/4 v4, 0x1

    invoke-virtual {v3, v0, v4, v2, v1}, Lcom/android/server/LightsService$Light;->setFlashing(IIII)V

    .line 1101
    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->lightHandler:Landroid/os/Handler;

    iget-object v4, p0, Lcom/android/server/NotificationManagerService;->updateLights:Ljava/lang/Runnable;
...
.method public enqueueNotificationInternal(Ljava/lang/String;IILjava/lang/String;IILandroid/app/Notification;[I)V
    ...
    invoke-direct {v0, v1}, Lcom/android/server/NotificationManagerService;->zteupdateLightsLocked(Landroid/app/Notification;)V

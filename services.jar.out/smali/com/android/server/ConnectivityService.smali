...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iput v3, v0, Lcom/android/server/ConnectivityService;->mCurrWlanPrefered:I
    ...
    .line 526
    new-instance v35, Landroid/net/wifi/TwStateTracker;

    move-object/from16 v0, v35

    move-object/from16 v1, p1

    invoke-direct {v0, v1}, Landroid/net/wifi/TwStateTracker;-><init>(Landroid/content/Context;)V

    .line 527
    .local v35, tst:Landroid/net/wifi/TwStateTracker;
    new-instance v36, Lcom/android/server/TwService;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/TwService;-><init>(Landroid/content/Context;Landroid/net/wifi/TwStateTracker;)V

    .line 528
    .local v36, twService:Lcom/android/server/TwService;
    const-string v3, "tw_wifi"
    ...
    const-string v4, "tw_wifi service can not be registered!\n"

    invoke-static {v3, v4}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 534
    :cond_15
    new-instance v21, Lcom/android/server/TwWifiPolicy;
    ...
    .line 566
    .end local v35           #tst:Landroid/net/wifi/TwStateTracker;
    .end local v36           #twService:Lcom/android/server/TwService;
    :cond_16
    :goto_f
    move-object/from16 v0, p0
    ...
    .line 600
    new-instance v3, Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;

    move-object/from16 v0, p0

    invoke-direct {v3, v0}, Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;-><init>(Lcom/android/server/ConnectivityService;)V

    move-object/from16 v0, p0

    iput-object v3, v0, Lcom/android/server/ConnectivityService;->mWlanObserver:Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;
    ...
    sget-object v4, Lcom/android/server/ConnectivityService;->CONTENT_URI:Landroid/net/Uri;

    const/4 v6, 0x1

    move-object/from16 v0, p0

    iget-object v7, v0, Lcom/android/server/ConnectivityService;->mWlanObserver:Lcom/android/server/ConnectivityService$WlanSettingsChangeObserver;
...
.method static synthetic access$2002(Lcom/android/server/ConnectivityService;Ljava/lang/String;)Ljava/lang/String;
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2102(Lcom/android/server/ConnectivityService;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2200(Lcom/android/server/ConnectivityService;)[Landroid/net/NetworkStateTracker;
    .locals 1
    .parameter "x0"
...
.method private handleConnect(Landroid/net/NetworkInfo;)V
    ...
    .line 1931
    :cond_0
    invoke-interface {v2, v6}, Landroid/net/NetworkStateTracker;->setTeardownRequested(Z)V
    ...
    const-string v5, "djt, call handleConnectivityChange in handleConnect"
...
.method private handleConnectivityChange(IZ)V
    ...
    const-string v16, "djt, handleConnectivityChange enter, netType = "
    ...
    const-string v16, "djt, handleConnectivityChange,mNetTrackers["
    ...
    invoke-direct {v0, v9}, Lcom/android/server/ConnectivityService;->addPDPDefaultRoute(Ljava/lang/String;)I
    ...
    iput-object v14, v0, Lcom/android/server/ConnectivityService;->mobileInterfaceName:Ljava/lang/String;
...
.method private handleDisconnect(Landroid/net/NetworkInfo;)V
    ...
    const-string v21, "djt, call handleConnectivityChange in handleDisconnect"
    ...
    const-string v22, "zhaoch, info.getType = "
    ...
    const-string v22, "zhaoch mNetTrackers[mActiveDefaultNetwork].getNetworkInfo().getType() "
    ...
    .line 1658
    .local v14, nt:Landroid/net/NetworkStateTracker;
    if-nez v14, :cond_c
    ...
    .end local v6           #i$:I
    .end local v10           #len$:I
    .end local v14           #nt:Landroid/net/NetworkStateTracker;
    :cond_b
    const-string v20, "ConnectivityService"

    const-string v21, "zhaoch, else"
    ...
    .restart local v6       #i$:I
    .restart local v10       #len$:I
    .restart local v14       #nt:Landroid/net/NetworkStateTracker;
    :cond_c
    const-string v20, "ConnectivityService"
    ...
    const-string v21, "zhaoch have connected network need ping"

    invoke-static/range {v20 .. v21}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1664
    const-string v20, "cmdProxy.type"

    const-string v21, "mmsping"

    invoke-static/range {v20 .. v21}, Landroid/os/SystemProperties;->set(Ljava/lang/String;Ljava/lang/String;)V

    .line 1665
    const-string v20, "cmdproxysvc"

    invoke-static/range {v20 .. v20}, Landroid/os/SystemService;->start(Ljava/lang/String;)V
